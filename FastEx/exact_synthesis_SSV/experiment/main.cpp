...
int main() {
    ...
    // 指定 SAT 编码输出文件的路径
    std::string sat_output_path = "/rshome/daikang.kuang/logicfactory_tool/FastEx/exact_synthesis_SSV/experiment/output.cnf";
    ...
    // 指定解码后的逻辑电路输出文件的路径
    std::string circuit_output_path = "/rshome/daikang.kuang/logicfactory_tool/FastEx/exact_synthesis_SSV/experiment/decoded_circuit.blif";
