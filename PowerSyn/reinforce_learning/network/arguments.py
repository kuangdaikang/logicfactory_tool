...
def get_args():
    ...
    parser.add_argument('--model_name', dest='model_name', type=str, default='model_glitch')
    parser.add_argument('--train_dir', dest='train_dir', type=str, default='../benchmarks/train_set')
    ...
    parser.add_argument('--test_list', dest='test_list', type=str, default='/rshome/sunan.zou/nas/PowerAwareSynthesis/benchmarks/test_set/test_list_small.txt')
    ...
    parser.add_argument('--fixed_mode', dest='fixed_mode', type=bool, default=False)
    parser.add_argument('--result_dir', dest='result_dir', type=str, default='/rshome/sunan.zou/nas/PowerAwareSynthesis/benchmarks/our')
