...
def main(arguments):
    ...
    env = gym.make('gym_genus:genus-v0', lib_file="/home/zousunan/nas/PowerAwareSynthesis/netlist/gsc145nm.lib",
                   feature_mode=args.feature_mode, obs_dim=obs_dim)
    model = PPO.load(model) if arguments.agent_type == 'PPO' else None
